...
@WebServlet(
        name = "Workorder info",
        description = "This is workorder_info servlet",
        urlPatterns = {"/workorder_info"}
)
...
//            statusDAO.claimSetStatusRecall(claimDAO.getClaim(Integer.parseInt(req.getParameter("claim_id"))));
            ...
            claim.setDateReturnToNew(new Date(new Date().getTime() + (1000 * 60 * 60)));
...
//            statusDAO.claimSetStatusRecall(claimDAO.getClaim(Integer.parseInt(req.getParameter("claim_id"))));
            Claim claim = claimDAO.getClaim(Integer.parseInt(req.getParameter("claim_id")));
            claim.setDateReturnToNew(new Date(new Date().getTime() + (1000 * 60 * 10)));
            statusDAO.claimSetStatusRecall(claim);
        }
...
//            statusDAO.claimSetStatusRecall(claimDAO.getClaim(Integer.parseInt(req.getParameter("claim_id"))));
            Claim claim = claimDAO.getClaim(Integer.parseInt(req.getParameter("claim_id")));
            claim.setDateReturnToNew(new Date(new Date().getTime() + (1000 * 60 * 30)));
            statusDAO.claimSetStatusRecall(claim);
        }
